...
func getFortune(cardSuit: Suit) {
    switch cardSuit {
    case .hearts:
        print("You will get hearts of people")
    case .spades:
        print("You would eat a fire paan today")
    case .clubs:
        print("You would enjoy dancing in a club today")
    case .diamonds:
        print("You gonna get jewllery soon")
    }
}
