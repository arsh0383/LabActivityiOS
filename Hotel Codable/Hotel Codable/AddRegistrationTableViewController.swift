...
//  Hotel Codable
//
//  Created by Arsh Beri on 27/08/25.
//
...
class AddRegistrationTableViewController: UITableViewController, SelectRoomTypeTableViewControllerDelegate {
    ...
    var isCheckOutDatePickersVisible: Bool = false {
        didSet {
            checkOutDatePicker.isHidden = !isCheckOutDatePickersVisible
   ...
   override func tableView(_ tableView: UITableView, heightForRowAt indexPath: IndexPath) -> CGFloat {
        ...
        case checkOutDatePickerCellIndexPath where
            isCheckOutDatePickersVisible == false:
            return  0
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if indexPath == checkInDateLabelCellIndexPath {
            ...
            isCheckOutDatePickersVisible.toggle()
            if isCheckOutDatePickersVisible {
                isCheckInDatePickerVisible = false
            }
