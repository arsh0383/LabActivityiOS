...
var arsh = User(name: "Arsh", age: 21, height: 190, weight: 80, activityLevel: 7)
print("\(arsh.name) is \(arsh.age) years old. He is \(arsh.height)cm tall and weighs \(arsh.weight)kg. His activity level is \(arsh.activityLevel).")
